<template>
  <q-page>
    <div class="flex flex-center q-ma-sm">
      <div class="row">
        <q-form class="form" @submit.prevent="subir()" autocorrect="off" autocapitalize="off" autocomplete="off"
          spellcheck="false">
          <q-img :src="`${taxiStore.urlServer}${taxiStore.user.foto}`" class="imagen q-mx-xl" :ratio="16 / 9">
          ...
          <div class="row">
            <div class="col-12">
              <q-file v-model="file" label="Cambie su foto (5Mb Max)" filled class="q-my-xl" max-file-size="5242880"
                accept=".jpg,.jpeg,.png" @rejected="onRejected" :filter="validarFile">
          ...
          <q-btn class="form-submit" type="submit" :disable="saveState" :color="saveState ? 'red' : 'green'"
            :loading="loading[0]" @click="progress = true">Guardar</q-btn>
